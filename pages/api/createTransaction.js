...
const sellerAddress = 'Ex6kchY3e5Fe1tqHzjX8tBDYnS6hkxJnubCAjy2C9UhT';
...
const createTransaction = async (req, res) => {
  ...
  const transferInstruction = createTransferCheckedInstruction(
    ...
    // We're just going to transfare some SOL
    ...
    console.log('this is transferIn:' + transferInstruction);
